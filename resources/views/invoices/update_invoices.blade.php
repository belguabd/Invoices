                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD"
                                    ...
                                    value="value="{{ $invoice->invoice_Date }}"" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" class="form-control">
                                    <option value="{{ $prodcut->id }}"> {{ $prodcut->product_name }}</option>
                                </select>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            $('select[name="Section"]').on('change', function() {
                ...
                var selectProduct = $('select[name="product"]');
                $.ajax({
                    url: "{{ URL::to('section') }}/" +
                        SectionId, // Generates the URL for the named route
                    type: "GET",
                    dataType: "json",
                    success: function(data) {
                        selectProduct.empty(); // Clear existing options
