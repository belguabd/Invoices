                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class=" d-flex justify-content-center align-items-center">
                                                     ...
                                                     <a href="{{ route('restore_invoice', ['id' => $invoice->id])}}" class="btn btn-sm btn-success mx-1"
                                                        data-toggle="tooltip" title="استعادة من الأرشيف"
                                                        onclick="return confirm('هل أنت متأكد من رغبتك في استعادة هذه الفاتورة من الأرشيف؟');">
