...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        {{-- <a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><img src="{{ URL::asset('assets/img/media/logo.png') }}" class="main-logo" alt="logo"></a> --}}
        {{-- <a class="desktop-logo logo-dark active" href="{{ url('/' . $page='index') }}"><img src="{{ URL::asset('assets/img/media/logo.png') }}" class="main-logo dark-theme" alt="logo"></a> --}}
        <a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . ($page = 'index')) }}"><img
                src="{{ URL::asset('assets/img/media/logo.png') }}" class="logo-icon" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . ($page = 'index')) }}"><img
                src="{{ URL::asset('assets/img/media/logo.png') }}" class="logo-icon dark-theme" alt="logo"></a>
    </div>
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            {{-- <li class="nav-item mt-3">
                <a class="nav-link tx-black tx-medium " href="{{ url('/' . ($page = 'home')) }}">
                    <i class="fas fa-home tx-13 "></i>
                    &nbsp;
                    &nbsp;
                    <span class="tx-13 tx-15  tx-normal ">الرئيسية</span>
                </a>
            </li> --}}
            <li class="slide">
                <a class="side-menu__item  tx-medium" href="{{ url('/' . ($page = 'home')) }}">
                    <i class="fas fa-home tx-black"></i> &nbsp;&nbsp;
                    <span class="tx-black  side-menu__label"><span
                            class="tx-black tx-15 tx-normal">الرئيسية</span></span>
                </a>
            </li>
            ...
            <div class="accordion" id="accordionExample">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="collapse" data-target="#collapseOne" aria-expanded="flase"
                        aria-controls="collapseOne" href="{{ url('/' . ($page = 'invoices')) }}">
                        <i class="fas fa-file-invoice tx-black tx-13"></i> &nbsp;&nbsp;
                        <span class="tx-black  side-menu__label"><span
                                class="tx-black tx-15 tx-normal">الفواتير</span></span>

                        <i class="angle fas fa-plus"></i></a>
                    <div id="collapseOne" class="collapse " aria-labelledby="headingOne" data-parent="#accordionExample">
                        <ul class="list-unstyled ">
                            <li><a class="tx-15 tx-normal tx-black invoices_open" href="{{ url('/' . ($page = 'invoices')) }}">قائمة
                                    الفواتير</a></li>
                            <li><a class="tx-15 tx-black tx-normal"
                                    href="{{ url('/' . ($page = 'payments/invoices')) }}">الفواتير المدفوعة</a></li>
                            <li><a class="tx-15 tx-black tx-normal"
                                    href="{{ url('/' . ($page = 'Invoice_UnPaid')) }}">الفواتير
                                    غير المدفوعة</a></li>
                            <li><a class="tx-15 tx-black tx-normal"
                                    href="{{ url('/' . ($page = 'Invoice_Partial')) }}">الفواتير
                                    المدفوعة جزئيا</a></li>
                            <li><a class="tx-15 tx-black tx-normal"
                                    href="{{ url('/' . ($page = 'invoices/archive')) }}">ارشيف
                                    الفواتير</a></li>
                        </ul>
                    </div>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="flase"
                        aria-controls="collapseTwo" href="{{ url('/' . ($page = 'invoices')) }}">
                        <i class="fas fa-file-invoice tx-13"></i> &nbsp;&nbsp;
                        <span class="tx-black  side-menu__label"><span
                                class="tx-black tx-15 tx-normal">الفواتير</span></span>
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                        <ul class="">
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-morris')) }}">Morris
                                    Charts</a>
                            </li>
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-flot')) }}">Flot
                                    Charts</a>
                            </li>
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-chartjs')) }}">ChartJS</a>
                            </li>
    ...
    <li class="slide">
        ...
        <ul class="slide-menu">
            ...
            <li><a class="slide-item" href="{{ url('/' . ($page = 'widget-notification')) }}">Widget-notification</a>
            </li>
...
<script>
    $(document).ready(function() {
        $(".invoices_open").on("click", function() {
            // Find the closest .collapse element and add the "show" class
