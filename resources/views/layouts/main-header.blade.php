<!-- main-header opened -->
<link rel="stylesheet" href="{{asset('assets/cssfont/font.css') }}">
<div class="main-header sticky side-header nav nav-item">
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="{{ url('/' . ($page = 'index')) }}"><img src="{{ URL::asset('assets/img/media/logo.png') }}"
        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-1">
                            <div class="d-flex wd-100p">
                                ...
                                <div class="mr-3 my-auto">
                                    ...
                                    <span class="abbreviate-text">{{ auth()->user()->email }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- =============================== --}}
                        <a class="dropdown-item" href="{{ route('logout') }}" onclick="handleLogoutClick(event);">
