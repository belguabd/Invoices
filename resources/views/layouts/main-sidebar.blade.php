<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				...
				<a href="{{ url('/' . $page='index') }}" class="d-flex justify-content-center align-items-center text-success"><img src="{{URL::asset('assets/img/media/logo.png')}}" class="main-logo" alt="logo"><h2><b>الفواتير</b></h2></a>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='cards') }}">التقارير العملاء</a></li>
						</ul>
					</li>
